...
SETTINGS = [
    AGLSetting(
        id="neither", label="vanilla", cascade_1st=False, cascade_2nd=False, second_order=False
    ),
    AGLSetting(
        id="cascade_only", label="c", cascade_1st=True, cascade_2nd=True, second_order=False
    ),
    AGLSetting(
        id="second_order_only", label="so", cascade_1st=False, cascade_2nd=False, second_order=True
    ),
