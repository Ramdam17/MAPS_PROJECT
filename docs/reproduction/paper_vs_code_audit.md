...
| `r_actor_critic_meta.py:SecondOrderNetwork`                                           | comparison_layer + wager + cascade + dropout                                          | Second-order + wager                | `src/maps/domains/marl/model.py` (Sprint 16) or reuse `core/second_order.py` (Sprint 11 ✅) (E.11)  |
