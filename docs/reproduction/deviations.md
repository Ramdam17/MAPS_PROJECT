...
|--------------------------------|-----------------------------------|------------------------|-------------------------------------------------|------------------------------------|:-------:|:---------------------------------|
| **D-blindsight-hidden-dim**    | `config.first_order.hidden_dim`   | **60**                 | grid `[30,40,50,60,100]` → T.9 selects 60       | **60** paper-faithful (D.25 2026-04-20, was 100) | ✅ config fix applied ; smoke validation pending (sbatch job IDs logged in Sprint-08 tracker) | D.25 — override `-o first_order.hidden_dim=100` for pre-D.25 |
